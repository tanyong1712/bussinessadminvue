<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/' }">仓库中心</el-breadcrumb-item>
            <el-breadcrumb-item>供应商管理</el-breadcrumb-item>
            <el-breadcrumb-item>供应商详情</el-breadcrumb-item>
        </el-breadcrumb>
         
         <div class="font_14 p_top_30"><strong>基本信息</strong></div>
         <div class="m_bottom_20">
             <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                <el-form-item label="供应商状态" style="width:100%;">
                    <el-col :span="2" >正常 </el-col>
                    <el-col class="line te_right p_right_10" :span="2">ID：</el-col>
                    <el-col :span="2 ">0016</el-col>
                </el-form-item>

                <el-form-item label="供应商名称" prop="supplierName">
                    <el-input v-model="ruleForm.supplierName" placeholder="请输入供应商名称" style="width:30%;"></el-input>
                </el-form-item>
                ...
                <el-form-item label="法人身份证" >
                    ...
                    <el-col class="line te_right" :span="2" style="width:1px;"> &nbsp; </el-col>
                    <el-col :span="11 " style="width:15%;">
                        <el-form-item >
                            <el-upload
                                action="https://jsonplaceholder.typicode.com/posts/"
                     ...
                     <!-- <el-col class="line te_right p_right_10" :span="2" style="width:90px;">营业执照 </el-col> -->
                    <el-col :span="11" style="width:20%;">
               ...
               <div class="font_14 p_bottom_10 p_top_10"><strong> 供应商渠道</strong></div>
                <el-table
                    :data="tableData"
                    stripe
                    style="width:50%">
                ...
                <div class="font_14 p_bottom_10 p_top_10"><strong> 操作日志</strong></div>
               <el-table
                    :data="operationData"
                    stripe
                    style="width:50%">
