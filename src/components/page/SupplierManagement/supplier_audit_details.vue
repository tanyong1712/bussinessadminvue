<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/' }">供货方管理</el-breadcrumb-item>
            <el-breadcrumb-item> 供货方审核详情</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="p_30 bg_fff m_top_20">
             <div class="font_14 "><strong>基本信息</strong></div>
         <div class="m_bottom_20 m_top_20">
             <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                 
                <el-form-item label=" 供货方名称" prop="supplierName">
                    <el-input v-model="ruleForm.supplierName" placeholder="请输入 供货方名称" style="width:30%;"></el-input>
                </el-form-item>
               ...
               <div class="font_14 p_bottom_30"><span class="red">*</span><strong>  供货方渠道</strong></div>
                <el-form-item label="来源类型" >
                    <el-select  placeholder="请选择来源类型" v-model="ruleForm.region"style="width:20%;">
                        <el-option label="渠道引进" value="1"></el-option>
                        <el-option label="总部引进" value="2"></el-option>
                    </el-select>
                </el-form-item> 
                <el-form-item label="渠道账号" style="width:100%;">
                    <el-col :span="11" style="width:20%;">
                        <el-form-item>
                            <el-input  placeholder="请输入渠道账号" ></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col class="line te_right p_right_10" :span="2" style="width:90px;">渠道类型 </el-col>
                    <el-col :span="11 ">
                             <el-select  v-model="ruleForm.region" placeholder="请选择 来源类型" style="width:30%;">
                            <el-option label="省级中心" value="1"></el-option>
                            <el-option label="区域中心" value="2"></el-option>
                        </el-select>
                    </el-col>
                </el-form-item>

                <el-form-item>
                     <el-button type="primary">审核通过</el-button> <el-button type="warning">审核拒绝</el-button>  <el-button>返回</el-button>
                </el-form-item>
    ...
    export default {
        ...
        data () {
            return {
                ...
                rules: {
                    supplierName: [
                        { required: true, message: '请输入 供货方名称', trigger: 'blur' },
