<template>
    <div>
        ...
        <div class="bg_fff p_30 m_top_20">
            ...
            <div class="dis_flex">
                <div class="item_wid font_14">颗粒度</div>
        ...
        <div class="bg_fff p_30 m_top_20">
            <div class="" id="chart_con" style="border: 1px solid #eeeeee;">
