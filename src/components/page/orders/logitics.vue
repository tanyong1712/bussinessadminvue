            ...
            <el-form :inline="true" ref="ruleForm" :model="ruleForm" class="demo-form-inline ">
                ...
                <div class="dis_flex m_bottom_10">
                    ...
                    <el-form-item label="发货方式">
                        <el-select v-model="ruleForm.fhmoethd">
        ...
        <div class="m_top_30 bg_fff p_30">
            ...
            <div class="border_DCDFE6 m_top_30 font_14">
                <div class="font_14 list_top_content bg_E4E7EE border_none dis_flex">
                     <div class="wid43 dis_flex">
                         <div class="wid47 te_center">商品信息</div>
                        <div class="wid16 te_center">商品价格</div>
                        <div class="wid16 te_center">商品数量</div>
                        <div class="wid16 te_center">售后状态</div>
                    </div>
                    <div class="wid31 dis_flex">
                        <div class="wid25 te_center">邮费</div>
                        <div class="wid25 te_center">实付金额</div>
                        <div class="wid25 te_center">支付方式</div>
                        <div class="wid25 te_center">订单状态</div>
                    </div>
                    <div class=" wid13 te_center">发货方式</div>
                    <div class="wid13 te_center">操作 </div>
                </div>
                <div class="w_100_per"  v-for="item in tableData">
                    <div class="dis_flex m_top_20 list_top_content bg_F4F5F7">
                        <div class="w_50_per dis_flex font_12">
                            <div class="m_left_30">内部订单号：{{item.id}}</div>
                            <div class="m_left_30">微信交易单号：{{item.orderNo}}</div>
                            <div class="m_left_30">下单时间：{{item.orderTime}}</div>
                            <div class="m_left_30">支付时间：{{item.paymentTime}}</div>
                        </div>
                        <div class="w_50_per te_right" @click="kefu(item.buyerId)"><span class="m_right_16">联系用户</span></div>
                    </div>
                    <div class="dis_flex">
                        <div class="w_50_per dis_flex" style="border-right: 1px solid #DCDFE6;">
                            <div class="w_100_per">
                                ...
                                <div class="w_100_per dis_flex" style="border-bottom:1px solid #DCDFE6; "
                                    ...
                                    <div class="w_15_per dis_flex flex_dir_cloumn ju_co_center te_center">*{{i.goodsNum}}</div>
                                    <div class="w_15_per dis_flex flex_dir_cloumn ju_co_center te_center">{{i.afterSalesStatus}}</div>
                                </div>

                            </div>
                        </div>
                        <div class="w_35_per dis_flex border_b_DCDFE6" style="border-right: 1px solid #DCDFE6;">
                            <div class="w_30_per dis_flex flex_dir_cloumn ju_co_center te_center">{{item.freight}}</div>
                            <div class="w_20_per dis_flex flex_dir_cloumn ju_co_center te_center">{{item.orderAmount}}</div>
                            <div class="w_30_per dis_flex flex_dir_cloumn ju_co_center te_center">{{item.paymentMethod}}</div>
                            <div class="w_20_per dis_flex flex_dir_cloumn ju_co_center te_center">{{item.statusName}}</div>

                        </div>
                        <div class="w_15_per dis_flex dis_flex flex_dir_cloumn ju_co_center border_b_DCDFE6" style="border-right: 1px solid #DCDFE6;">{{item.fhmethod}}
                            <!-- <div class="w_20_per dis_flex flex_dir_cloumn ju_co_center">{{item.fhmethod}}</div> -->
                        </div>
                        <div class="w_15_per dis_flex dis_flex flex_dir_cloumn ju_co_center border_b_DCDFE6" style="border-right: 1px solid #DCDFE6;">
                            <div class="" v-if="item.id==1">
                                ...
                                <!--<el-button >修改备注</el-button>&lt;!&ndash;@click="viewBeizhuMsg(item.id)"&ndash;&gt;-->
                            </div>
                        </div>
                    </div>
                </div>
